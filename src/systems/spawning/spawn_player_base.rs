...
use crate::{
    components::spacestation::SpaceStation,
    events::{spawn_planet_event::SpawnPlanetEvent, spawn_sprite_event::SpawnSpriteEvent},
    resources::{constants::SPACESTATION_DISTANCE_FROM_CENTRE, game_settings::GameSettings},
};
...
pub fn spawn_space_stations(
    ...
    for player in 1..game_settings.number_of_players + 1 {
        ...
        transform.translation += transform.up() * SPACESTATION_DISTANCE_FROM_CENTRE;
